    ...
    new Promise( (resolve) => {
        ...
        const renderMicMode = (el) => {
            ...
            micButton.onclick = async () => {
                ...
                handleMicStatus(state).catch(e=>console.log(e));                permissionStatus.onchange = () => handleMicStatus(state).catch(e=>console.log(e));
            };
...
const NWJSCode = async () => {
    const thegui = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('nw.gui')); });
    ...
    win.showDevTools();
    const { inputSockets } = await Promise.resolve().then(function () { return require('./websocket-server.js'); });
